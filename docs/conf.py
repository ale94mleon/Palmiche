...
html_theme_options = {
    "repository_url": "https://github.com/ale94mleon/Palmiche/",
    "path_to_docs": "docs",
...
html_logo = "source/_static/logo.svg"
...
intersphinx_mapping = {
    ...
    'OpenMM': ('http://docs.openmm.org/latest/userguide/', None),
    'OpenFF': ('https://docs.openforcefield.org/projects/toolkit/en/latest/', None),
